...
public class ChapterMenuPlay implements Screen {
    private Viewport viewport;
    private Stage stage;
    private Game game;
    public ChapterMenuPlay(Game game) {
        this.game=game;
        ...
        Label chapterLabel = new Label("CHAPTER 1: THE ESCAPE ",font1);
    ...
    public void render(float delta) {
        if(Gdx.input.justTouched()){
            game.setScreen(new PlayScreen((PersevereGame) game));
            dispose();
        }
